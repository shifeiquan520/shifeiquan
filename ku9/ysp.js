...
function main(item) {
    ...
    try {
        ...
        try { getPlayUrlFunc = getPlayUrl; } catch (e) {}
        if (!getPlayUrlFunc) {
            try { getPlayUrlFunc = eval("getPlayUrl"); } catch (e) {}
        }
        if (!getPlayUrlFunc) {
            try { getPlayUrlFunc = playUrl; } catch (e) {}
        }
        if (!getPlayUrlFunc) {
            return { url: "" };
        }
